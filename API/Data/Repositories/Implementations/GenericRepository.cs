...
namespace API.Data.Repositories.Implementations
{
  ...
  public class GenericRepository<T> : IDisposable, IGenericRepository<T> where T : class
  {
    ...
    public GenericRepository(EBayDbContext context) { Context = context; }
    ...
    public virtual IQueryable<T> GetAllQueryableNonTracking() { return Context.Set<T>().AsNoTracking(); }
    ...
    public virtual async Task<T> GetById(int id) { return await Context.Set<T>().FindAsync(id); }
